                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Edit Suplier
                                   ...
                                   <form Action="{{ route('suplier.update',$suplier->id)}}" method="post" enctype="multipart/form-data">
                                       @csrf
                                       @method('put')
                                       <div class="panel-body">
                                           <label>Suplier</label>
                                           <input type="text" class="form-control" name="suplier" value="{{$suplier->suplier}}">
                                       </div>
                                <div class="panel-body">
                                    <label>Alamat</label>
